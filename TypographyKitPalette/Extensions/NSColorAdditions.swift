...
extension NSColor {
    ...
    private func darker(darkness: Double) -> NSColor {
        ...
        return NSColor(red: newR, green: newG, blue: newB, alpha: alpha)
    }

    private func lighter(lightness: Double) -> NSColor {
    ...
    public func shade(_ lightness: Lightness) -> NSColor {
        switch lightness {
        case .white:
    ...
    public func shade(_ darkness: Darkness) -> NSColor {
        return self.darker(darkness: darkness.scale)
    }

    public func shade(_ name: String) -> NSColor {
        switch name {
        case "light":
            return shade(.light)
        case "lighter":
